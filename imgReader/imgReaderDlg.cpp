...
// CimgReaderDlg 消息处理程序

BOOL CimgReaderDlg::OnInitDialog()
{
...
void CimgReaderDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CimgReaderDlg::OnQueryDragIcon()
{
